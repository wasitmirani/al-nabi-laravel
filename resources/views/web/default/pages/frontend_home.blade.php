@extends(getTemplate().'.layouts.master')
@section('content')
                ...
                <div class="d-flex align-items-start">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-name-1" role="tabpanel"
                            ...
                            <img src="{{asset('/frontend/assets/images/Untitled-5.png')}}" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="slider1">
                                    <div class="item">
                                        <div class="box">
                                            <img src="{{asset('/frontend/assets/images/books-pic.png')}}" alt="">
                                            <h4>Lorem Ipsum</h4>
                                    ...
                                    <div class="item">
                                        <div class="box">
                                            <img src="{{asset('/frontend/assets/images/books-pic3.png')}}" alt="">
                                            <h4>Lorem Ipsum</h4>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                industry. </p>
                                            <div class="box-in">
